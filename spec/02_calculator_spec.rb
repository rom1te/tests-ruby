...
describe "#multiply" do
  ...
  it "multiplies two other numbers" do
    ...
    expect(multiply(12, 11)).to eq(132)
  end
...
describe "#power" do
  ...
  it "raises 0 number to the power of another number" do
  ...
  it "raises a negative number to the power of another positive number" do
    # Attention, le signe n'est pas prioritaire dans le calcul...
